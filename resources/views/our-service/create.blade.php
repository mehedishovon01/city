...
@section('header')
    <div class="page-title-heading text-primary">
        ...
        <div class="page-title-subheading">
            Add Our New Service Without Any Hassel!!!
        </div>
    </div>
@endsection
    ...
    <div class="app-inner-bar">
        ...
        <div class="inner-bar-right">
            <div class="btn-actions-pane-right">
                <a type="button" href="{{ route('our-services.index') }}" class="btn-icon btn-wide btn-outline-2x btn btn-outline-focus btn-sm d-flex">
                    Our Service List
                </a>
            </div>
        </div>
...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form id="signupForm" class="col-md-5 mx-auto" method="post" action="{{ route('our-services.store') }}"
