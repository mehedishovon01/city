    ...
    <div class="app-inner-bar">
        ...
        <div class="inner-bar-right">
            <div class="btn-actions-pane-right">
                <a type="button" href="{{ route('our-services.create') }}"
...
@section('content')
    <div class="main-card mb-3 card">
                ...
                <tbody>
                    @foreach ($our_services as $value)
                        <tr>
                            ...
                            <td><a href="{{ route('users.show', $value->id) }}">{{ Str::limit($value->title, 10) }}</a></td>
                            ...
                            <td class="text-center">
                                <div role="group" class="btn-group-sm btn-group">
                                    ...
                                    <div id="popover-content-{{ $value->id }}" class="d-none">
                                        ...
                                        <a href="{{ route('units.edit', $value->id) }}" class="btn-shadow btn btn-primary mr-1"><i class="fa fa-fw"
        ...
        {{-- Rounded Paginations --}}
        @include('partials._paginate',['style' => 'rounded', 'data' => $our_services,])
    </div>
@endsection
