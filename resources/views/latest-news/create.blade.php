...
@section('header')
    <div class="page-title-heading text-primary">
        ...
        <div class="page-title-subheading">
            Add New Latest News Without Any Hassel!!!
        </div>
    </div>
@endsection
...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form id="signupForm" class="col-md-5 mx-auto" method="post" action="{{ route('latest-news.store') }}"
                novalidate="novalidate" enctype='multipart/form-data'>
                @csrf
                <h2 class="text-center">Create Latest News!</h2>
                ...
                <div class="input-group">
                    ...
                    <input required placeholder="Header Title" type="text" id="header_title" name="header_title" class="form-control">
                </div><br>
                ...
                <div class="input-group">
                    ...
                    <input required placeholder="Link" id="linik" name="link" type="text" class="form-control">
                </div><br>
