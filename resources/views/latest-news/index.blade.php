    ...
    <div class="app-inner-bar">
        ...
        <div class="inner-bar-right">
            <div class="btn-actions-pane-right">
                <a type="button" href="{{ route('latest-news.create') }}"
...
@section('content')
    <div class="main-card mb-3 card">
                ...
                <tbody>
                    @foreach ($latest_news as $value)
                        <tr>
                            ...
                            <td><a href="{{ route('users.show', $value->id) }}">{{ $value->link ?: 'Null' }}</a></td>
        ...
        {{-- Rounded Paginations --}}
        @include('partials._paginate',['style' => 'rounded', 'data' => $latest_news,])
    </div>
@endsection
