...
@section('header')
    <div class="page-title-heading text-primary">
        ...
        <div class="page-title-subheading">
            Add New Unit Without Any Hassel!!!
        </div>
    </div>
@endsection
...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form id="signupForm" class="col-md-5 mx-auto" method="post" action="{{ route('units.store') }}"
                ...
                <div class="input-group">
                    ...
                    <input required placeholder="Unit Name" type="text" id="name" name="name" class="form-control">
                </div><br>
                ...
                <div class="input-group">
                    ...
                    <input placeholder="Unit Slug" type="text" id="slug" name="slug" class="form-control">
                </div><br>
                ...
                <div class="input-group">
                    ...
                    <input placeholder="Full Name" id="full_name" name="full_name" type="text" class="form-control">
                </div><br>
                <br>
