    ...
    <div class="app-inner-bar">
        ...
        <div class="inner-bar-right">
            <div class="btn-actions-pane-right">
                <a type="button" href="{{ route('units.create') }}"
...
@section('content')
    <div class="main-card mb-3 card">
                ...
                <tbody>
                    @foreach ($units as $value)
                        <tr>
                            ...
                            <td><a href="{{ route('users.show', $value->id) }}">{{ $value->slug ?: 'Null' }}</a></td>
                            <td><a href="{{ route('users.show', $value->id) }}">{{ $value->full_name ?: 'Null' }}</a>
                            </td>
        ...
        {{-- Rounded Paginations --}}
        @include('partials._paginate',['style' => 'rounded', 'data' => $units,])
    </div>
@endsection
