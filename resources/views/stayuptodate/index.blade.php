@extends('layouts.app')
@section('title', 'Stay Up To Date Lists')
@section('header')
            ...
            <ul class="nav">
                <li class="nav-item">
                    <a role="tab" data-toggle="tab" id="tab-nav-1" class="nav-link active" href="#tab-content-1"
                        aria-selected="false">
                        <span>Stay Up To Date List</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="table-responsive">
            <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
                ...
                <tbody>
                    @foreach ($stay_up_to_date as $value)
                        <tr>
        ...
        {{-- Rounded Paginations --}}
        @include('partials._paginate',['style' => 'rounded', 'data' => $stay_up_to_date,])
    </div>
@endsection
